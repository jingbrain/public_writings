...
基于 ‘输出2_精炼_Opus.md’，在保持原意前提下，让语言更生动、节奏更好、增加钩子
把原始提示词，以及你的输出稿，以 markdown 格式输出到文件 '输出3_润色_GPT.md'。
...
它最窄处只有 **39 公里**，却承载着全球约 **20%** 的石油供应。波斯湾的油要去亚洲、去欧洲，大多得从这里穿过去。
